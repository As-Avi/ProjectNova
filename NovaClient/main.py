...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--modulo", type=str, required=True, help="Modulo 0 = VIEW | 1 = FILTEREDVIEW [obbligatorio]")
    ...
    parser.add_argument("-l", "--language", type=str, required=False, help="Lingua del progetto [opzionale, default: 'it']", default="it")

    args = parser.parse_args()

    # creo la form
    App(args.modulo, args.url, args.file,  args.language)